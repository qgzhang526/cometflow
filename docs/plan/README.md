...
| Web 前端可见性 | 把「后端算出来了、但只能敲命令」清零：findings / metrics / current-change 指针 / doctor 维护动作（V1），证据回收、回滚指引与写保护状态（V2），门禁 / 追溯 / 导入 / 锚点（V3），余项见 V4 | **V1–V3 已完成**（V4 已排序未细化） | [web-ui-visibility-plan.md](./web-ui-visibility-plan.md) |
