...
| Web 前端后续 | 引用关系图与引用高亮、Job 持久化、并发写保护、spec 编辑语义、发布链路收尾 | **M1、M2 已完成**（N1/N2/N3/N5）；M3 待实施（N4 为 warn→fail 两段式，含到期硬提醒） | [web-ui-followup-plan.md](./web-ui-followup-plan.md) |
