...
| 调度并发与排序 | C1 原子领取 + change 级互斥 ✅；C2 依赖排序 ✅；C3 `--concurrency N` 槽位并发 ✅；C4 守卫按 module 判归属（装了守卫也能并发，前提 module 声明齐全且不相交）✅ | **C1–C4 均已实施**（2026-09-17，回归 148 步） | [scheduler-concurrency-plan.md](./scheduler-concurrency-plan.md) |
