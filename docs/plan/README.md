...
| Web 前端可见性 | 把「后端算出来了、但只能敲命令」清零：findings / metrics / current-change 指针 / doctor 维护动作（V1），再到证据回收、回滚指引与写保护卡片（V2–V4） | **V1 已完成**（V2–V4 已排序未细化） | [web-ui-visibility-plan.md](./web-ui-visibility-plan.md) |
