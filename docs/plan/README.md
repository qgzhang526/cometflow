...
| 调度并发与排序 | C1 原子领取 + change 级互斥 ✅；C2 依赖排序 ✅；C3 `--concurrency N` 槽位并发（无守卫 + 不同 spec_ref）✅；C4 并发策略（ADR 0028）✅ | **C1–C4 均已实施**（2026-09-17，回归 147 步） | [scheduler-concurrency-plan.md](./scheduler-concurrency-plan.md) |
