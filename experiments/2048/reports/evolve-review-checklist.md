...
|---|---|---|---|---|---|---|---|---|
| 1 | web-version | ready-for-review | G6 网页版 | ✅ 已合入（b25e70d 实现 + 69ce0ff 正规化） | 4 门禁 OK | **批准**（确认一致后回填 commit） | ✅ 批准 | 2026-09-02 evolve approve 归档 |
| 2 | web-animations | ready-for-review | G7 动画 | ✅ 已合入（51614d8） | 4 门禁 OK | **批准** | ✅ 批准 | 2026-09-02 evolve approve 归档 |
| 3 | web-ai-demo | ready-for-review | G8 AI 演示 | ✅ 已合入（985267d） | 4 门禁 OK | **批准** | ✅ 批准 | 2026-09-02 evolve approve 归档 |
| 4 | web-undo | ready-for-review | G9 撤销 | ✅ 已合入（9270aa6，agent 提交） | 4 门禁 OK + spec lock 归零 | **批准** | ✅ 批准 | 2026-09-02 evolve approve 归档 |
| 5 | ai-heuristic-weight | **approved** | G3 AI 权重 | ✅ 已落地（a86b4c4：EMPTY 270→320） | 落地后全门禁 OK | **需落地实测后决策** | ✅ 批准（部分正结果） | c1：win_rate 0.01→0.03、score +5.3%；≥10pp 未达但全面可复现提升 |
| 6 | sci-eval-demo | verified | 平台 Phase 2 | 无代码改动 | 4 门禁 OK + eval pass@k/pass^k=1.00 | **批准=记录** | ✅ 批准 | 2026-09-02 evolve approve 归档 |
